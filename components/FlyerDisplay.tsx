      ...
      <div className="w-full flex flex-col items-center justify-start px-2 md:px-0 pt-2 md:py-12 relative z-0">
        ...
        {showComparison && !isDraft && typeof draftImageUrl === 'string' && draftImageUrl.length > 0 && typeof hdImageUrl === 'string' && hdImageUrl.length > 0 && (
          <div className="fixed inset-0 z-50 bg-checkered overflow-y-auto">
            ...
            <div className="flex flex-col items-center justify-start lg:justify-center w-full max-w-6xl mx-auto py-3 lg:pt-[30px] px-3 lg:px-4">
              ...
              <div className="mt-4 flex flex-col lg:flex-row items-center justify-center gap-3 w-full max-w-4xl px-3">
                {/* Botón Generar nuevo borrador */}
                <button
                  onClick={() => {
                    setShowComparison(false);
                    // Trigger regeneración desde el formulario
                    window.scrollTo({ top: 0, behavior: 'smooth' });
                  }}
                  className="w-full lg:w-auto px-6 py-3 bg-blue-500/20 hover:bg-blue-500/30 border border-blue-500/50 text-blue-300 font-medium rounded-xl transition-all text-sm flex items-center justify-center gap-2"
                >
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" />
                  </svg>
                  <span>Generar nuevo borrador</span>
                </button>
