            ...
            <div className="h-14 flex-shrink-0 flex items-center justify-between px-4 border-b border-white/5 z-20 relative">
                ...
                <div className="flex items-center gap-1">
                    ...
                    <button
                      ...
                      className="hidden md:flex items-center justify-center h-7 w-9 rounded-lg bg-white/5 hover:bg-white/10 border border-white/10 text-white/70 transition-all hover:border-white/30 active:scale-95 cursor-pointer touch-manipulation z-[60] relative"
