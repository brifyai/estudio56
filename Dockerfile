...
RUN echo "NODE_ENV=production" > .env && \
    ...
    echo "VITE_GOOGLE_VERTEX_LOCATION=us-central1" >> .env && \
    echo "FAL_AI_API_KEY=53f17bdf-d098-44d0-af18-5c7cc1984203:4ae450f687dd2d6b04b75fcdc8fe7d28" >> .env && \
    echo "GEMINI_API_KEY=AIzaSyA40oZ6hUsB4PaZ1emgzDLez06P4ZNmJfw" >> .env && \
    echo "GOOGLE_VERTEX_PROJECT=stratega-ai-x" >> .env && \
    ...
    echo "SECRETS_SCAN_SMART_DETECTION_ENABLED=false" >> .env
